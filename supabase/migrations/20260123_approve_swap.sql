-- Migration: create approve_swap RPC for atomic swap approval
-- Run this in Supabase (or via migration runner)

-- Create function that returns a simple success/error table to be consumed by the app
