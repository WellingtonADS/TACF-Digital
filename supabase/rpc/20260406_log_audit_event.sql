-- RPC segura para registrar auditoria sem insert direto em audit_logs no frontend.
...
comment on function public.log_audit_event(text, text, text)
is 'Registra evento de auditoria com controle de papel (admin/coordinator) via SECURITY DEFINER.';
